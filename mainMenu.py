...
def student_details(student):
    ...
    Parameters:
    - student (list): A list with student information:
        [Name, Password, Addition Score, Subtraction Score, Multiplication Score, Division Score, Boss Score]
    ...
    while run:
        ...
        for i, line in enumerate(titles):
            incorrect_text = get_font("Shojumaru",30).render(line, True, pygame.Color('black'))
